print("[INFO]: INITIALIZING THE DEXDECRYPT_MUSIC SERVER")
...
print("[INFO]: INITIALIZING DATABASE OF DEXDECRYPT_MUSIC SERVER")
...
async def load_sudoers():
    global SUDOERS
    print("[INFO]: LOADING SUDO USERS OF DEXDECRYPT_MUSIC")
...
ASSUSERNAME = ""
ASSMENTION = ""
print("[INFO]: INITIALIZING BOT CLIENT OF DEXDECRYPT_MUSIC")
app = Client(
    'YukkiBot',
    API_ID,
    API_HASH,
