...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO DEXDECRYPT_MUSIC SERVER")
        try:
    ...
    for served_chat in served_chats:
        try:
            ...
            print("Error came while clearing db")
            pass     
    await app.send_message(LOG_GROUP_ID, "Dexdecrypt_Music Bot Started")
    await client.send_message(LOG_GROUP_ID, "Assistant Of Dexdecrypt_Music Started")
    print("[INFO]: STARTED THE VENOM BOT AND SENDING THE INFO TO DEXDECRYPT SERVER")
