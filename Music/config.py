...
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '1159894809').split()))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", ''))
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DEXDECRYPT_MUSIC")
ZAID_SUPPORT = getenv("ZAID_SUPPORT", "DOST_HAI_SAB")
